...
const PerformanceCalculator_1 = __importDefault(require("../../services/PerformanceCalculator"));
...
class TenantControls {
    constructor() {
        ...
        this.getTenantPerformance = (req, res) => __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
                const landlordId = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a.landlords) === null || _b === void 0 ? void 0 : _b.id;
                if (!landlordId) {
                ...
                if (!(tenant === null || tenant === void 0 ? void 0 : tenant.propertyId))
                    return res.status(404).json({ error: `tenant with the id :  ${tenantId} is not connected to a property` });
                const performance = yield PerformanceCalculator_1.default.calculateOverallScore(tenant === null || tenant === void 0 ? void 0 : tenant.userId);
