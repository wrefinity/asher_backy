...
class ApplicationLandlordRouter {
    ...
    initializeRoutes() {
        ...
        this.router.post('/existing-user-invites/:userId', applicant_controller_1.default.createInviteForExistingUser);
        ...
        this.router.post('/send-agreement-doc/:id', applicant_controller_1.default.sendAgreementForm);
