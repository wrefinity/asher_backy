...
class TenantsLandlordRouter {
    ...
    initializeRoutes() {
        ...
        this.router.get('/scores/:tenantId', tenant_controller_1.default.getTenantPerformance);
        ...
        this.router.get('/documents/:tenantId', tenant_controller_1.default.getterTenantsDocument);
    }
}
