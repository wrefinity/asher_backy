...
class PropertyUnit {
    ...
    getUnitByProperty(propertyType, propertyId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const units = yield __1.prismaClient.unitConfiguration.findMany({
                where: whereClause,
                include: {
                    images: true,
                    ResidentialProperty: true,
            ...
            const formattedUnits = units.map(unit => {
                const { ResidentialProperty, CommercialProperty } = unit, rest = __rest(unit, ["ResidentialProperty", "CommercialProperty"]);
                return Object.assign(Object.assign({}, rest), { residential: ResidentialProperty, commercial: CommercialProperty });
            });
