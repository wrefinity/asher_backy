...
class PropertyDocsRouter {
    ...
    initializeRoutes() {
        this.router.post('/uploads', this.authenticateService.authorize, multer_1.default.array('files'), multerCloudinary_1.uploadToCloudinary, propertyDocument_controller_1.default.create);
