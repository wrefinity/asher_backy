...
import { updatePropertySchemaNew } from "../../validations/schemas/properties.schema";
...
class ApartmentLandlordRouter {
    ...
    private initializeRoutes() {
        ...
        this.router.post('/property/:propertyId/sync-listing-status', PropertyController.syncPropertyListingStatus)
